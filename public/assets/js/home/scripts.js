! function(e) {
    ...
    p.templates = p.templates || {}, Object.assign(p.templates, {
                        ...
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                ...
                                return (i = {
                                    ...
                                    url: t.ajaxUrl
                                })["GET" === i.method ? "params" : "data"] = t.ajaxData, e.next = 7, _()(i);
                            case 7:
                ...
                value: (n = c()(o.a.mark((function t(n) {
                    ...
                    return o.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            ...
                            case 3:
                                s = i._renderPartial(i.templates.ajax), i.wrapper.querySelector(i._getClassName(".&__inner")).innerHTML = s, p()(v()(e.prototype), "open", this).call(this, n);
                            case 6:
                            case "end":
                                return t.stop()
                        }
    ...
    $((function() {
        ...
        $(".card-media").each((function() {
            ...
            t.on("load", (function() {
                c = function() {
                    if (b.length) return "none" !== getComputedStyle(b.find("video")[0]).display
                }(), "mobile" !== e.version && c || !b.length || b.appendTo(".card-media__video-holder"), "desktop" !== e.version ? (l.slick(w), a.css({
                    "padding-bottom": 0
                }), v = !0) : S(r.scrollTop())
            })), t.on("version-changed.card-media", (function() {
                if (v && (l.slick("unslick"), v = !1), b.length && b.appendTo("mobile" !== e.version && c ? l : ".card-media__video-holder"), "desktop" !== e.version) try {
                    l.slick(w), v = !0
                } catch (e) {
                    v = !1
                }
            ...
            function S(e) {
                ...
                f.each((function() {
                    var i = $(this);
                    e + _.height() + t.height() / 2 >= i.offset().top && n !== i.index() && (n = i.index())
                })), T(n), h.eq(n).addClass("card-media__thumbs-item_active").siblings().removeClass("card-media__thumbs-item_active")
            }
            ...
            setInterval((function() {
                ...
                if (e.preventDefault(), window.matchMedia("(min-width: 1280px)").matches) {
                    var t = $(this),
                        n = t.index();
                    h.eq(n).addClass("card-media__thumbs-item_active").siblings().removeClass("card-media__thumbs-item_active"), t.hasClass("card-media__item_video") || function(e) {
                ...
                e.preventDefault(),
                    function(e) {
                        m.removeClass("t-zoom"), d.slick("slickSetOption", "speed", 0), L(e, 0), g = !1
                    }($(this).index())
            })), h.on("click", (function(e) {
                e.preventDefault();
                var t = $(this),
                    n = t.index();
                t.addClass("card-media__thumbs-item_active").siblings().removeClass("card-media__thumbs-item_active"), g ? d.slick("slickGoTo", n) : window.matchMedia("(min-width: 1280px)").matches ? (L(n), T(n)) : l.slick("slickGoTo", n)
            ...
            var q = window.sessionStorage.getItem("loop") || 0,
                O = Number(q) >= 1 ? "2" : "1";
            Number(q) < 2 && (E(2e3, {
                width: "193px"
            }, {
                ...
                opacity: 0
            }), window.sessionStorage.setItem("loop", O)), new i.a({
    ...
    $((function() {
        ...
        function p(e) {
            var t = $(c).eq(e),
                ...
                l = $(s.$slides[r]);
            for (n.slick("slickPlay"), o.slick("slickPause"), h(l, !0), i = 0; i <= a.$slides.length; i++) h($(a.$slides[i]), !1)
        }
        ...
        s.each((function() {
            ...
            threshold: 1
        }), $("html").addClass("t-full-page"), m() > 0 ? v(m()) : (p(0), $(c).eq(0).find(".full-page__slider:visible .full-page__header_grey").length ? $(".page").addClass("page-gray") : $(".page").removeClass("page-gray"), a.eq(0).addClass("full-page__nav-item_active")), e.on("touchmove", preventDefault), $(".menu").on("toggle", (function(e, t) {
            ...
            n.slick({
                ...
                if (function(e) {
                    ...
                    var u = $(".featherlight__dots").find(".slick-active").last(),
                        ...
                        h = $(".featherlight__dot").eq(0);
                    $(u).addClass("small"), $(d).addClass("small"), $(h).removeClass("small"), $(f).removeClass("small")
                }
            ...
            function() {
                ...
                r = $(".instashop-media-mobile"), c = $(".header").outerHeight(), $(document).on("click", ".js-instashop-shop", (function() {
                    if (r = $(".instashop-media-mobile"), $(".js-instashop-shop").removeClass("js-instashop-shop-active"), !0 === l) {
                        l = !1;
                        var f = $(this),
                            h = f.closest(".instashop-media-mobile"),
                            p = (h.offset().top, f.data("ajax-tab")),
                            m = h.next(),
                            v = f.siblings(".js-instashop-details-active");
                        if (s = h.find(".instashop-media-mobile__description"), v.removeClass("js-instashop-details-active"), !m.hasClass("tab-goods")) return !1;
                        if (s.hasClass("instashop-media-mobile__description_active") && (u(s, !1), h.find(".js-instashop-details").removeClass(".js-instashop-details-active")), h.hasClass("instashop-media-mobile_active")) return void 0 !== e && (d(h, m, !1), h.removeClass("instashop-media-mobile_active"), e = void 0, f.removeClass("js-instashop-shop-active")), !1;
                        r.removeClass("instashop-media-mobile_active"), f.addClass("js-instashop-shop-active"), h.addClass("instashop-media-mobile_active"), o = h.find(".js-inner-media"), currentElemHeight = h.outerHeight(), m.addClass("tab-goods_active"), t = m.find(".preloader"), n = m.find(".popup-goods__inner"), i = m.find(".popup-goods"), $.ajax({
                            url: p,
                            method: "get",
                            beforeSend: function() {
                            ...
                            success: function(s) {
                                n.html(s), n.imagesLoaded().done((function() {
                                    t.removeClass("preloader_active"), a = e, i.one("transitionend", (function() {
                                        ...
                                        function(e, t, n) {
                                        ...
                                        }(h, currentElemHeight, o), o.one("transitionend", (function(e) {
                                            ! function(e, t, n) {
                                            ...
                                            }(h.offset().top, c, (function() {
                                                if (void 0 !== a) {
                                                    if (a[0] === h[0]) return l = !0, !1;
                                                    d(a, a.next(), !0)
                                                }
                                                l = !0
                                            }))
    ...
    $((function() {
        ...
        function f(e) {
            t.length && (s != e ? (! function(e) {
                e < n.length ? (t.parent().height(i * e + 12 * e), h(e)) : t.parent().attr("style", "")
            }(e), s = e) : h(e))
        }
        ...
        $(window).resize((function() {
            ...
            t = $(window).height(),
                ...
                }(o, t) || (e.hasClass("slick-initialized") && e.slick("unslick"), p(t)), f(d($(window).height()))
        })), p(o), f(d(o)), e.on("slideTo", (function(t, n) {
                ...
                s.find(".subscribe-form__field").removeClass("error"), f({
                    ...
                    success: function(i) {
                        ...
                        ! function(t, n) {
                            ...
                            d(a.index(this))
                        })) : i.success && (d(l + 1), o ? s.trigger("success", p) : 1 === l && function() {
                            var i = c.crm,
                            ...
                            h(), t.on("beforeunload." + r, a), t.on("unload." + r, a)
                        }())
                    }
                })
    ...
    $((function() {
        if (null !== document.querySelector(".support-rating")) {
            var e = document.querySelector(".support-rating"),
                ...
                p = JSON.parse(sessionStorage.getItem("ratePost".concat(u))),
                m = null === p ? null : p.time,
                v = null === p ? null : p.answer;
            null !== p && (1 === v ? (e.style.display = "none", t.style.display = "block") : 0 === v && (e.style.display = "none", n.style.display = "block"));
            var g = {
                type: 1,
                model_id: Number(u),
                user_id: f
            ...
            r.addEventListener("click", (function() {
                if ((new Date).getTime() - Number(m) >= 864e5) {
                    ...
                    b("/api/rates/save", n).then((function(n) {
                        var i = n.data;
                        i.id;
                        if (i.success) {
                ...
                if ((new Date).getTime() - Number(m) >= 864e5) {
                    ...
                    b("/api/rates/save", t).then((function(t) {
                        var o = t.data,
                            s = o.id,
                            a = o.success;
                        if (console.log(s, a), a) {
                            ...
                            l.addEventListener("keyup", (function(e) {
                                ...
                                if (l.value.trim().length <= 2) d.style.display = "block";
                                    ...
                                    b("/api/rates/save", t).then((function(e) {
                                        var t = e.data,
                                            o = t.id,
                                            s = t.success;
    ...
    $((function() {
        ...
        function n(e) {
            ...
            var i, a = document.querySelector(".sizes-selector__title"),
                ...
                h = document.querySelector(".card-info__soon"),
                p = document.querySelector(".card-info__preorder"),
                m = 1 === c.length,
                v = document.querySelector(".card-button-locale--add-to-cart").innerHTML,
                _ = document.querySelector(".card-button-locale--subscribe").value,
                b = document.querySelector(".card-button-locale--subscribed").value,
                y = document.querySelector(".card-button-locale--preorder").value;
            if (m) {
                var w = c[0],
                    k = w.dataset.id,
                ...
                a.innerHTML = "".concat(x, " ").concat(j), u = {
                    ...
                    dataAction: T,
                    warningPopup: E
                }, "subscribe" === S || "in-stock" === S ? (l.innerHTML = t(_), l.classList.remove("disabled")) : "subscribed" === S ? (l.innerHTML = t(b), l.classList.add("disabled")) : p ? (l.innerHTML = t(y), l.classList.remove("disabled")) : (l.innerHTML = v, l.classList.remove("disabled")), l.style.display = "block", E && "buy" === S && l.click()
            }
            d > 1023 && document.body.addEventListener("click", (function(e) {
                ...
                e.addEventListener("click", (function(e) {
                    ...
                    a.innerHTML = "".concat(document.querySelector(".card-button-locale--size").value, " ").concat(i, " ").concat(s), $(r).slideUp(300), a.classList.remove("sizes-selector__title--opened"), u = {
                        ...
                        dataAction: d,
                        warningPopup: h
                    }, "subscribe" === c || "in-stock" === c ? (l.innerHTML = t(_), l.classList.remove("disabled")) : "subscribed" === c ? (l.innerHTML = t(b), l.classList.add("disabled")) : p ? (l.innerHTML = t(y), l.classList.remove("disabled")) : (l.innerHTML = v, l.classList.remove("disabled")), document.querySelector(".product-to-cart").style.display = "none", l.style.display = "block", h && "buy" === c && l.click(), l.removeEventListener("click", q), l.addEventListener("click", q)
                }))
            }));
            var q = function(e) {
                if (d > 1023) {
            ...
            l.removeEventListener("click", q), l.addEventListener("click", q);
            var O = function(e, t) {
                    var i;
                    t && t.close(), p || ((i = e.cartCount) > 0 ? $(".basket-button__count").html(i).show() : 0 === i && $(".basket-button__count").html(0).hide()), e.mindbox && directCrm("performOperation", e.mindbox);
                    var o = e.response.product || {},
                        s = o.active,
                        a = o.maxStockQuantity;
                    !0 === s && a > 0 ? (window.sendAddToBasketEvents({
                        preorder: Boolean(p)
                    }), p ? (n(!0), window.location.href = e.cart_url) : (document.querySelector(".product-to-cart").style.display = "block", l.style.display = "none", new window.basePopup({
                        context: {
                        ...
                        onOpened: function() {
                            ...
                            } else gaSendEvent("Add2CartNoReserve", p ? "preorder" : "", "PopupSite")
                        },
                        onClosed: function() {
                            ...
                            document.querySelectorAll(".popupify__inner .card-sizes__item").forEach((function(i) {
                                ...
                                i.addEventListener("click", (function(e) {
                                    ...
                                    D(l, u, r, c), null !== r || null !== c ? $.get(a, (function(e) {
                                        ...
                                        n(!1), O(e, o), t.innerHTML = "".concat(document.querySelector(".card-button-locale--size").value, " ").concat(l, " ").concat(d)
                                    })))
                                }))
                            }))
                        }
                ...
                I = function() {
                    ...
                    new s.a({
                        ...
                        onOpened: function() {
                            ...
                            var r = o()(a).map((function(e) {
                                ...
                                u = new g({
                                    ...
                                    onChange: function(e) {
                                        i = e, c.classList.remove("disabled"), "subscribe" === e.state || "in-stock" === e.state ? l.innerText = _ : "subscribed" === e.state ? (l.innerText = b, c.classList.add("disabled")) : "buy" === e.state && (l.innerHTML = p ? y : v)
                                    }
                                }),
                                d = function() {
                                    var i = u.getValue();
                        ...
                        onClosed: function() {
                            ...
                            a.innerHTML = "".concat(n.text, " ").concat(o), document.querySelector(".product-to-cart").style.display = "none", l.style.display = "block", l.classList.remove("disabled"), "subscribe" === n.state || "in-stock" === n.state ? l.innerHTML = t(_) : "subscribed" === n.state ? (l.innerHTML = t(b), l.classList.add("disabled")) : "buy" === n.state && (e ? (document.querySelector(".product-to-cart").style.display = "block", l.style.display = "none") : l.innerHTML = p ? t(y) : v)
                        }
                    })
                },
                D = function(e, t, n, i) {
                    var o = [e, t.toLowerCase()];
                    null !== f && o.push(f.innerText.trim()), null !== h && o.push(h.innerText.trim()), null === n && null === i || gaSendEvent("Size selected", o.join(", "))
                }
        }))
    }))
}, , function(e, t, n) {
    ...
    var v = function(e) {
        ...
        return a()(n, [{
            key: "_getDefaultContext",
            value: function() {
                var e = c()(p()(n.prototype), "_getDefaultContext", this).call(this);
    ...
    var v = function(e) {
        ...
        return a()(n, [{
            ...
            key: "_getDefaultOptions",
            value: function() {
                var e = c()(p()(n.prototype), "_getDefaultOptions", this).call(this);
                return Object.assign(e, {
                    closeAction: "reject",
                    onConfirm: function() {},
                    onReject: function() {}
     ...
     */
    ! function(s) {
        if (void 0 === (o = "function" == typeof(i = s) ? i.call(t, n, t, e) : i) || (e.exports = o), !0, e.exports = s(), !!0) {
        ...
        return function n(i) {
            ...
            function s(t, n, s) {
                if ("undefined" != typeof document) {
                    ...
                    var r = "";
                    for (var c in s) s[c] && (r += "; " + c, !0 !== s[c] && (r += "=" + s[c].split(";")[0]));
            ...
            function a(e, n) {
                if ("undefined" != typeof document) {
                    for (var o = {}, s = document.cookie ? document.cookie.split("; ") : [], a = 0; a < s.length; a++) {
                        var r = s[a].split("="),
                            c = r.slice(1).join("=");
            ...
            return o.set = s, o.get = function(e) {
                return a(e, !1)
    ...
    "scrollRestoration" in history && (history.scrollRestoration = "manual"), jQuery((function(e) {
        ...
        s.mapping = ["First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh"], n.find(".ab-2592-a").each((function() {
            e(this).find(".categories-card").each((function() {
                i = i.add(this)
            }))
        })), n.find(".ab-2592-b").each((function() {
            e(this).find(".categories-card").each((function() {
                o = o.add(this)
            }))
        })), i.each((function(t) {
            e(this).attr("data-ga-name", s(t)), e(this).attr("data-position", t + 1)
        })), o.each((function(t) {
            e(this).attr("data-ga-name", s(t)), e(this).attr("data-position", t + 1)
        }));
        var a = 0;
        window.optimizeTesting = window.optimizeTesting || {}, t = setInterval((function() {
            "b" === window.optimizeTesting[2592] && (n.find(".ab-2592-a").css({
                display: "none"
            }), n.find(".ab-2592-b").css({
                display: "block"
            }), n.find(".home-categories__list").slick({
                arrows: !1,
                dots: !0,
                slidesToShow: 1,
                slidesToScroll: 1,
                responsive: [],
                useTransform: !0
            })), a += 1, (window.optimizeTesting[2592] || a > 10) && clearInterval(t)
        }), 500)
    }));
    var c = 0;
    ...
    function u(e, t, n) {
        var i = e.attr("data-ga-name");
        t = i ? i + " " + t : "", n = n || e.find(".categories-card__title").text(), t && !u.cache[t] && (u.cache[t] = !0, r.a.dataLayer.pushEvent("Main page", t, n))
    }
    u.cache = {}, jQuery((function(e) {
        i = e(".page"), o = new IntersectionObserver((function(t) {
            t.forEach((function(t) {
                t.isIntersecting && e(t.target).trigger("js-intersect")
            }))
        }), {
            rootMargin: "0px 0px 0px 0px",
            threshold: [.5]
        }), i.on("click", ".card-colors__link", (function(e) {
            e.preventDefault(), window.location.href = e.currentTarget.dataset.href
        }))
    })), jQuery((function(e) {
        e(".home-top-buttons").each((function() {
            var t = e(this);
            ...
            t.find(".categories-buttons__item").each((function() {
                o.observe(this)
            })), t.on("js-intersect", ".categories-buttons__item", (function() {
                var t = n(e(this));
                r.a.dataLayer.pushEvent("mobile.menu", "show", t)
            })), t.on("click", ".categories-buttons__item", (function() {
                var t = n(e(this));
                r.a.dataLayer.pushEvent("mobile.menu", "click", t)
            }))
        }))
    })), jQuery((function(e) {
        e(".hero").each((function() {
            var t, n = e(this),
                i = n.attr("data-id"),
                s = n.attr("data-title").trim(),
                a = ((t = Object.assign({}, window.homeBannerOptions || {})).withZoom = !!(t.withZoom && window.helpers && window.helpers.getURLParameter("zoom")), t.zoomDuraion = 2e4, t),
                c = {
                    name: "Основной баннер на главной странице DESKTOP",
                    creative: "#" + i + ": " + (s || "Перейти"),
                    position: "Основной баннер"
                };
            n.attr("data-ga-name", "First block"), o.observe(n[0]), n.on("js-intersect", (function() {
                u(n, "show", s), r.a.dataLayer.pushData({
                    event: "gtm-ee-event",
                    ecommerce: {
                        promoView: {
                            promotions: [c]
            ...
            })), n.find(".hero__video").eq(0).each((function() {
                var t = e(this),
                    i = t[0];
                l() || (t.on("canplay", (function() {
                    setTimeout((function() {
                        n.find(".hero__image-wrapper").addClass("hero__media--hidden")
                    }), 500), setTimeout((function() {
                        i.play()
                    }), 1e3)
                })), i.load())
            })), n.find(".hero__image").eq(0).each((function() {
                var t = e(this);

                function n(e, t) {
                    for (var i = Object.assign({}, n.cached || {
                            x: e + (t - e) / 2,
                            y: e + (t - e) / 2
                        }), o = i; Math.abs(i.x - o.x) < (t - e) / 4;) o = {
                        x: e + Math.round(Math.random() * (t - e)),
                        y: e + Math.round(Math.random() * (t - e))
                    };
                    return n.cached = o, Object.assign({}, o)
                }
                a.withZoom && function e() {
                    var i = n(10, 90);
                    t.css({
                        "transform-origin": i.x + "% " + i.y + "%"
                    }), t.addClass("hero__image--zoom"), setTimeout((function() {
                        t.removeClass("hero__image--zoom")
                    }), a.zoomDuraion), setTimeout((function() {
                        e()
                    }), a.zoomDuraion + 200)
                }()
            })), n.on("click", ".hero__holder", (function() {
                u(n, "click", s), r.a.dataLayer.pushData({
                    event: "gtm-ee-event",
                    ecommerce: {
                        promoClick: {
                            promotions: [c]
        ...
        var t = {
            getCategoryData: function(e) {
                return {
                    name: "Баннеры на главной странице " + (l() ? "MOBILE" : "DESKTOP"),
                    creative: e.attr("data-title").trim(),
                    position: 1 * e.attr("data-position") + (l() ? 0 : -1)
                }
            },
            pushCategoryIntersect: function(e) {
                var n = t.pushCategoryIntersect.cache,
                    i = t.getCategoryData(e);
                i.creative in n || (n[i.creative] = !0, r.a.dataLayer.pushData({
                    event: "gtm-ee-event",
                    ecommerce: {
                        promoView: {
                            promotions: [i]
        ...
        t.pushCategoryIntersect.cache = {}, t.pushCategoryClick = function(e) {
            var n = t.getCategoryData(e);
            r.a.dataLayer.pushData({
                event: "gtm-ee-event",
                ecommerce: {
                    promoClick: {
                        promotions: [n]
        ...
        }, e(".categories-card").not(".home-categories__item").each((function() {
            o.observe(this), c += 1
        })), i.find(".home-categories__wrapper").each((function() {
            e(this).find(".home-categories__item").each((function() {
                o.observe(this)
            }))
        })), i.on("js-intersect", ".categories-card", (function() {
            var n = e(this);
            u(n, "show"), t.pushCategoryIntersect(n)
        })), i.on("click", ".categories-card", (function() {
            var n = e(this);
            u(n, "click"), t.pushCategoryClick(n)
        }))
    })), jQuery((function(e) {
        var t = e(window);
        e(document);
        ...
        e(".home-slider").each((function() {
            var i = e(this),
                s = i.attr("data-key"),
                a = i.attr("data-name"),
                c = i.attr("data-ga-name"),
                l = window[s] || [],
                u = [],
                d = !1;
            ...
            function f() {
                var t = [];
                i.find(".home-slider__item").each((function(i, o) {
                    var s = e(o);
                    if (t.length < 4 && s.hasClass("slick-active") && s.width() > 0) {
                        var a = s[0].dataset.id,
                            r = n(l, a);
                        r && u.indexOf(a) < 0 && (u.push(a), t.push(r))
                    }
                })), t.length && r.a.dataLayer.pushData({
                    event: "gtm-ee-event",
                    ecommerce: {
                        currencyCode: "RUB",
                        impressions: t
            ...
            function h() {
                var e = i.find(".catalog-list__preview"),
                    t = 1.25 * e.first().width();
                e.css({
                    height: t
                })
            }
            i.on("js-intersect", (function() {
                d || (d = !0, r.a.dataLayer.pushEvent("Main page", c + " show")), f()
            })), i.on("click", "a.home-slider__item", (function(e) {
                ...
                if (i) {
                    ...
                    r.a.dataLayer.pushData(o), r.a.dataLayer.pushEvent("Main page", c + " click", i.position);
                    var s = window.localStorage.getItem("ga_product_data"),
                        u = new Date;
                    if (s) {
                        (s = JSON.parse(s)).length >= 30 && s.splice(0, 1);
                        var d = s.filter((function(e) {
                            return Number(e.id) !== Number(i.id)
                        }));
                        d.push({
                            id: i.id,
                            list: o.ecommerce.click.actionField.list,
                            position: i.position,
                            timestamp: u.getTime()
                        }), window.localStorage.setItem("ga_product_data", JSON.stringify(d))
                    } else window.localStorage.setItem("ga_product_data", JSON.stringify([{
                        id: i.id,
                        list: o.ecommerce.click.actionField.list,
                        position: i.position,
                        timestamp: u.getTime()
            ...
            })), i.find(".home-slider__list").on("swipe", (function(e, t, n) {
                f()
            })), i.on("click", ".slick-arrow", (function() {
                f._delayed && window.clearTimeout(f._delayed), f._delayed = setTimeout((function() {
                    f._delayed = null, f()
                }), 500)
            })), o.observe(i[0]), h(), t.on("resize-delayed", (function() {
                h()
            }))
        }))
    })), jQuery((function(e) {
        e(".home-previews-slider").each((function() {
            var t = e(this),
                n = t.attr("data-ga-name");

            function i(e) {
                return {
                    name: "Баннеры на главной странице " + (l() ? "MOBILE" : "DESKTOP"),
                    creative: "Истории: " + e.attr("data-title").trim(),
                    position: 1 * e.attr("data-position") + c
                }
            }
            o.observe(t[0]), t.find(".preview-link").each((function() {
                o.observe(this)
            })), t.on("js-intersect", ".preview-link", (function(t) {
                var n = e(this),
                    s = i(n);
                r.a.dataLayer.pushData({
                    event: "gtm-ee-event",
                ...
                }), o.unobserve(n[0]), t.stopPropagation()
            })), t.on("js-intersect", (function() {
                r.a.dataLayer.pushEvent("Main page", n + " show"), o.unobserve(t[0])
            })), t.on("click", ".preview-link", (function() {
                var t = e(this),
                    o = i(t),
                    s = 1 * t.attr("data-position");
                r.a.dataLayer.pushEvent("Main page", n + " click", s), r.a.dataLayer.pushData({
                    event: "gtm-ee-event",
                    ecommerce: {
                        promoClick: {
                            promotions: [o]
        ...
        var t = a.a.get("gdeslon.ru.__arc_token") ? "gdeslon" : "";
        window.site = window.site || {}, window.gdeslon_q = window.gdeslon_q || [], window.gdeslon_q.push({
            page_type: "main",
            merchant_id: "85122",
            deduplication: t,
            user_id: window.site.userId ? window.site.userId : ""
        })
    }))
}]);