    ...
    <div class="page__row">
      ...
      <div class="page__middle">
        <div class="profile-edit profile__edit">
          <form id="dynamic-form" class="form profile-edit__form" action="/user/edit" method="post" autocomplete="off">
                ...
                <div class="profile-edit__item">
                  <div class="profile-edit__holder">
                    ...
                    <div class="form__item field-user-email required">
                      ...
                      <div class="form__field"><input type="text" class="form-control" id="user-email" class="form__input" name="User[email]" value="a@a.com" disabled="" maxlength="255" aria-required="true">
                    ...
                    <div class="form__item field-user-name">
                      ...
                      <div class="form__field"><input type="text" class="form-control" id="user-name" class="form__input" name="User[name]" maxlength="255">
                        <p class="form__error-message"></p>
                      </div>
                    </div>
                    <div class="form__item no-surname-hide field-user-surname">
                      <label class="form__label" for="user-surname">Фамилия</label>
                      <div class="form__field"><input type="text" class="form-control" id="user-surname" class="form__input" name="User[surname]" maxlength="255">
                        <p class="form__error-message"></p>
                      </div>
                    </div>
                    <div class="form__item field-user-birthday_date">
                      <label class="form__label" for="user-birthday_date">Дата рождения</label>
                      <div class="form__field"><input type="text" class="form-control" id="user-birthday_date" class="form__input" name="User[birthday_date]" value="" data-plugin-inputmask="inputmask_d60cdaa9">
                        <p class="form__error-message"></p>
                      </div>
                    </div>
                    <div class="form__item field-user-number">
                      <label class="form__label" for="user-number">Телефон</label>
                      <div class="form__field">
                        <div class="intl-tel-input allow-dropdown">
                          ...
                          </div><input type="tel" id="user-number" class="form__input" name="User[number]" autocomplete="off" placeholder="+7">
                        </div>
                        <p class="form__error-message"></p>
                      </div>
                    </div>
                    <div class="form__item field-user-dress_size">
                      <label class="form__label" for="user-dress_size">Размер одежды</label>
                      <div class="form__field">
                        <div class="select form__select">
                          <div class="select__block"><select id="user-dress_size" class="select__field" name="User[dress_size]">
                    ...
                    <div class="form__item field-user-shoe_size">
                      <label class="form__label" for="user-shoe_size">Размер обуви</label>
                      <div class="form__field">
                        <div class="select form__select">
                          <div class="select__block"><select id="user-shoe_size" class="select__field" name="User[shoe_size]">
                              <option value="">не указан</option>
            ...
            <div class="profile-edit__confirm">
              <div class="checkbox form__checkbox field-user-accept">
                <input type="hidden" name="User[accept]" value="0"><input type="checkbox" id="user-accept" class="checkbox__input" name="User[accept]" value="1"><label class="checkbox__label" for="user-accept"><span class="checkbox__label-text">я соглашаюсь на обработку моих персональных данных и ознакомлен(а) с&nbsp;<a href="/r/privacy_policy" class="checkbox__link" target="_blank">условиями конфиденциальности</a></span></label>
                <p class="form__error-message"></p>
              </div>
            </div>

          </form>
          <button type="submit" class="button button_powdery button_fixed profile-edit__button card__button_with-spaces save">Сохранить изменения</button>
