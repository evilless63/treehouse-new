...
<body>
    ...
    route('user.article', [
        'slug' => $c_article->slug,
                                                    ...
                                                    <span class="menu__text ">
                                                        {{ $c_article->getLocalizeTitle(LaravelLocalization::getCurrentLocale()) }}</span></a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
    ...
    route('user.article', [
        'slug' => $article->slug,
                                                    ...
                                                    class="menu__sub-link">
                                                    <span
                                                        class="menu__text ">{{ $article->getLocalizeTitle(LaravelLocalization::getCurrentLocale()) }}</span></a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                  ...
                  <input type=" text" name="search" placeholder="{{ __('userpanel.find_on_site_placeholder') }}"
                                            autocomplete="off" class="search__input" value="" />
                                        <button type="submit" class="search__button"><i
                        ...
                        <div class="menu__contact">
                            ...
                            <div class="menu__contact-item">
                                <a class="menu__contact-link" href="https://www.messenger.com/t/domnadereve"
                                    target="_blank">
                ...
                <div class="menu__holder">
                    <div class="menu__tools">
                        <div class="menu__tools-item menu__tools-item--globus">
                            @if (LaravelLocalization::getCurrentLocale() == 'ru')
                                <a href="{{ LaravelLocalization::getLocalizedURL('en') }}"
                                    class="menu__tools-button menu__tools-button_globus">
                        ...
                        <div class="menu__tools-item  menu__tools-item--user">
                            <a href="{{ LaravelLocalization::localizeUrl('/user/cabinet') }}"
                                class="menu__tools-button menu__tools-button_user">
            ...
            <header class="header ">
                ...
                <div class="menu-button__holder">
                  ...
                  <div class="menu-button__line menu-button__line_bottom"></div>
                            ...
                            <a href="/catalog?search=" class="header-search header-search--left"><i
                                    class="header-search__icon"></i></a>
                                            ...
                                            <div class="row">
                                                <div class="column">
                                                    @foreach ($categories as $main_category)
                                                        ...
                                                        <a href="{{ LaravelLocalization::localizeUrl(route('user.category', $main_category->slug)) }}"
                                                            class="header-link">{{ $main_category->getLocalizeTitle(LaravelLocalization::getCurrentLocale()) }}</a>
    ...
    route('user.article', [
        'slug' => $c_article->slug,
                                                ...
                                                <div class="column">
                                                    @if (LaravelLocalization::getCurrentLocale() == 'ru')
                                                        <a href="{{ LaravelLocalization::getLocalizedURL('en') }}"
                                                            class="reference-tools__link en-US header-search--right">
                                                            <i
                                                                class="reference-tools__icon reference-tools__icon_lang"></i>{{ __('userpanel.english') }}</a>

                                                    @else
                                                        <a href="{{ LaravelLocalization::getLocalizedURL('ru') }}"
                                                            class="reference-tools__link en-US header-search--right">
                                                            <i
                                                                class="reference-tools__icon reference-tools__icon_lang"></i>{{ __('userpanel.russian') }}</a>
                                    ...
                                    <div class="subscribe-form__title">{{ __('userpanel.subscribe_title') }}
                                        <div class="subscribe-form__field">
                                            <input class="subscribe-form__input" type="text" name="email"
                                                ...
                                                placeholder="{{ __('userpanel.subscribe_email_placeholder') }}" />
                                        </div>
                                        <div
                                            class="subscribe-form__button subscribe-form__button--mail subscribe-form__js-submit">
                            ...
                            <nav class="bottom-menu media-query-show-footer_tablet">
                                ...
                                <div class="footer-col">
                                    <div class="footer-col__item footer-col-item" data-slug="info">
                                        <span class="footer-col-item__title"><i
                                                class="arrow-icon"></i>{{ __('userpanel.customers') }}</span>
        ...
        'slug' => $c_article->slug,
                                ...
                                <div class="footer-col">
                                    <div class="footer-col__item footer-col-item" data-slug="about">
                                        <span class="footer-col-item__title"><i
                                                class="arrow-icon"></i>{{ __('userpanel.company') }}</span>
                                        <ul class="footer-col-item__list footer-list">
                                            @foreach ($company_articles as $article)
                                                <li class="footer-list__item footer-list-item">
                                                    <a class="footer-list-item__link"
                        ...
                        <a class="footer-list-item__link footer-list-item__link-social footer-list-item__link--telegram" target="_blank" href="tg://resolve?domain=twelvestoreez_bot">
                          Telegram
                                    ...
                                    <div class="footer-col__item footer-col-item">
                                        <a href="/user/cabinet" class="footer-col-item__title"><i
                                                class="arrow-icon"></i>{{ __('userpanel.lc') }}</a>
                                        <ul class="footer-col-item__list footer-list">
                                            <li class="footer-list__item footer-list-item">
                                                <a class="footer-list-item__link"
                                                    href="{{ LaravelLocalization::localizeUrl('/user/cabinet') }}">
                                        ...
                                        <form class="subscribe-form " action="/subscribe-ajax" method="POST">
                                            ...
                                            <div class="subscribe-form__screen visible" data-name="contacts">
                                                <div class="subscribe-form__title">
                                                    {{ __('userpanel.subscribe_title') }}</div>
                                                <div class="subscribe-form__field">
                                                    <input class="subscribe-form__input" type="text" name="email"
                                                        maxlength="255" autocomplete="off"
                                                        placeholder="{{ __('userpanel.subscribe_email_placeholder') }}" />
                                ...
                                <ul class="footer-socials__list footer-socials-list">
                                    <li class="footer-socials-list__item footer-socials-list-item">
                                        <a class="footer-socials-list-item__link footer-socials-list-item__link--youtube "
                                            href="https://www.youtube.com/channel/UCryN_G-kFyzq8k2XQdgAx4w"
                                            target="_blank" rel="nofollow"></a>
                                    </li>
                                    <li class="footer-socials-list__item footer-socials-list-item">
                                        <a class="footer-socials-list-item__link footer-socials-list-item__link--facebook "
                                            href="https://www.facebook.com/domnadereve" target="_blank"
                                            rel="nofollow"></a>
                                    </li>
                                    <li class="footer-socials-list__item footer-socials-list-item">
    ...
    <script>
        $(document).ready(function() {
            $('.header__left-panel').mouseover(function() {
