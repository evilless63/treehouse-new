            ...
            <div class="catalog-list catalog-list_wrap catalog__list">
              ...
              'color' => $product_by_category->color->slug,
                        ...
                        <div class="catalog-list__preview">
                          ...
                          <img src="{{asset('uploads/single/' . $product_by_category->main_img)}}" alt="{{$product_by_category->product->getLocalizeTitle(LaravelLocalization::getCurrentLocale())}}" class="catalog-list__image" />
                        </div>
                      </a>
