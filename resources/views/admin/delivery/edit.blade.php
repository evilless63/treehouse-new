<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight mt-16">
            Способы доставки -- Редактирование
        </h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{route('delivery.update', $delivery->id)}}"  enctype="multipart/form-data">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="">
                            <input type="text" class="form-control " name="method" value="{{$delivery->method}}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="">
                            <input type="number" step="0.01" class="filepond my-4" name="price" value="{{$delivery->price}}">
                            </div>
                        </div>

                        <div class="mb-5">
                            <div class="form-check">
                                <input type="checkbox" name="payable" @if($delivery->payable) checked @endif>
                        ...
                        <div class="mb-5">
                            <div class="form-check">
                                <input type="checkbox" name="calculable" @if($delivery->calculable) checked @endif>
                                <label class="form-check-label">
                        ...
                        <div class="mb-5">
                            <div class="form-check">
                                <input type="checkbox" name="archived" @if($delivery->archived) checked @endif>
                                <label class="form-check-label">
